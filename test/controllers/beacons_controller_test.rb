...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { description: @beacon.description, factory_id: @beacon.factory_id, latitude: @beacon.latitude, longitude: @beacon.longitude, name: @beacon.name, owner_id: @beacon.owner_id }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { description: @beacon.description, factory_id: @beacon.factory_id, latitude: @beacon.latitude, longitude: @beacon.longitude, name: @beacon.name, owner_id: @beacon.owner_id }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
